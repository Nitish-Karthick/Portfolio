...
export const PROJECTS: Project[] = [
  {
    title: 'Study Mate',
    description: 'An AI-driven PDF learning assistant for students. It extracts text, preserves layout, segments content, and builds semantic embeddings for accurate retrieval. Features include summaries, contextual Q&A, and adaptive quizzes, all while prioritizing student privacy.',
    imageUrl: p1,
  ...
  },
  {
    ...
    description: 'This very portfolio website, built to be clean, modern, and fully responsive using React and TypeScript.',
    imageUrl: p2,
